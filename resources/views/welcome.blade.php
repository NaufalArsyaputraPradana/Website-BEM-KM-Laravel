        ...
        <div class="row justify-content-evenly">
            <div class="col-lg-4 mb-3">
                <div class="bg-white rounded-3 p-3 shadow mb-2 d-flex align-items-center justify-content-between">
                    <div>
                        <h5><a href="/ormawa">Organisasi Mahasiswa <br> Universitas Dian Nuswantoro</a></h5>
                    </div>
            ...
            <div class="col-lg-4 mb-3">
                <div class="bg-white rounded-3 p-3 shadow mb-2 d-flex justify-content-between align-items-center">
                    <div>
                        <h5><a href="/ukm">Unit Kegiatan Mahasiswa <br> Universitas Dian Nuswantoro</a></h5>
                    </div>
...
<div class="container py-5">
    <img src="{{ asset('assets/images/Pres-Wapres.png') }}" class="card border-0 img-fluid" style="display:block; margin:auto;" alt="">
</div>
...
<section id="video" class="py-5">
    <div class="container py-5">
        <div class="text-center">
            <iframe width="100%" height="515" src="https://www.youtube.com/embed/8VOB1Z37fnk?si=2hnoW9mhPDj6cSJJ"
